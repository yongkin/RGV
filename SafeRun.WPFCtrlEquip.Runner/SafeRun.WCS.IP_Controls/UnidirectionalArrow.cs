...
namespace SafeRun.WCS.IP_Controls
{
    ...
    ///
    /// </summary>
    public class UnidirectionalArrow : HMIControlBase
    {
        static UnidirectionalArrow()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(UnidirectionalArrow), new FrameworkPropertyMetadata(typeof(UnidirectionalArrow)));
        }
