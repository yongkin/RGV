...
namespace SafeRun.WCS.IP_Controls
{
    ...
    ///
    /// </summary>
    public class DirectionArrow : HMIControlBase
    {
        static DirectionArrow()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(DirectionArrow), new FrameworkPropertyMetadata(typeof(DirectionArrow)));
        ...
        public static readonly DependencyProperty IsAlarmOnProperty = DependencyProperty.Register("IsAlarmOn", typeof(bool), typeof(Stacker));
