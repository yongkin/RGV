...
{
    /*
      案例<IP_Controls:RoundedCornersPolygon Points="10,50 180,50 180,150 300,150 300,250 10,250" 
StrokeThickness="20" Stroke="#FFC52A2A" ArcRoundness="5" UseRoundnessPercentage="True" IsClosed="True" />
    */
